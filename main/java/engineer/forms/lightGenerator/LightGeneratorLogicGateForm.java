...
public class LightGeneratorLogicGateForm<T extends LightGeneratorLogicGateContainer> extends LogicGateContainerForm<T> {
    protected final GameEventListener<LogicGateEntity.ApplyPacketEvent> applyListener;

    public LightGeneratorLogicGateForm(Client client, final T container) {
