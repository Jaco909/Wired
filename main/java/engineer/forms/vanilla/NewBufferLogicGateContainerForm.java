...
public class NewBufferLogicGateContainerForm<T extends BufferLogicGateContainer> extends LogicGateContainerForm<T> {
    private final GameEventListener<LogicGateEntity.ApplyPacketEvent> applyListener;

    public NewBufferLogicGateContainerForm(Client client, final T container) {
        ...
        this.addComponent(new FormContentIconButtonShaded(this.getWidth()-25, 5, FormInputSize.SIZE_20, ButtonColor.BASE, Settings.UI.button_help_20, new GameMessage[]{new LocalMessage("ui", "buffergatelogictip")}));
