...
public class LogicBenchTier2 extends CraftingStationObject {
    public ObjectDamagedTextureArray texture;

    public LogicBenchTier2() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = ObjectDamagedTextureArray.loadAndApplyOverlay(this,"objects/LogicBenchTier2");
    }
    ...
    public CraftingStationUpgrade getStationUpgrade() {
        return new CraftingStationUpgrade(ObjectRegistry.getObject("LogicBenchTier3"), new Ingredient[]{new Ingredient("anyvoidtrap", 5), new Ingredient("wire", 20)});
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("LOGICBENCH2"), RecipeTechRegistry.getTech("LOGICBENCH")};
    }
}